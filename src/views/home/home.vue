			...
			<Card :padding="0">
				...
				<div class="map-con">
					...
					<Row type="flex" justify="center" align="middle">
						<home-map :city-data="cityData" @click="mapClick"></home-map>
						<div class="test" v-show="show">asdasd</div>
					</Row>
					</Col>
				</div>
			</Card>
...
export default {
	...
	created() {
		...
		// this.$get('http://127.0.0.1:3002/').then(d=>{
		// 	console.log(d);
		// });
		// this.$get('http://127.0.0.1:3002/api/parsetime',{
		// 	iso:date.toISOString()
		// }).then(d=>{
		// 	console.log(d);
		// });
		// this.$get('http://127.0.0.1:3002/api/unixtime',{
		// 	iso:date.toISOString()
		// }).then(d=>{
		// 	console.log(d);
		// });
		// this.$get('http://127.0.0.1:3001/api/phone',{
		// 	phone:18501667661
		// }).then(d=>{
		// 	console.log(d);
		// });
